                    ...
                    <form method="POST" action="/courses/{{$course->id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group my-group"> 
                                    ...
                                    <input id="duration_value" type="text" class="form-control @error('duration_value') is-invalid @enderror" name="duration_value" value="{{ old('duration_value') ?? $course->duration_value }}" required autocomplete="off">

                                    <select id="duration_type" class="form-control @error('duration_type') is-invalid @enderror" name="duration_type" value="{{ old('duration_type') ?? $course->duration_type }}" required autocomplete="off" autofocus>
                        ...
                        <div class="offset-md-4 col-md-6">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="status_active" value="active" @if((old('status') ?? $course->status ??  'active') == 'active') checked @endif>
                                <label class="form-check-label" for="status_active">{{ __('Ativo') }}</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="status_inactive" value="inactive" @if((old('status') ?? $course->status ?? 'active') == 'inactive') checked @endif>
